...
/*   Updated: 2023/11/28 17:35:20 by cbernot          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	main(void) {
	...
	{
		std::cout << std::endl << "Creating a span of size 10..." << std::endl;
		Span sp = Span(10);
	...
	{
		std::cout << std::endl << "Creating a span of size 1..." << std::endl;
		Span sp = Span(1);
		sp.addNumber(42);
		try {
	...
	{
		std::cout << std::endl << "Creating a span of size 10000..." << std::endl;
		Span sp = Span(10000);
